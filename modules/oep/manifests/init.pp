...
$responseFile = '/vagrant/oep_install_responsefile'
$inventoryLocFile = '/vagrant/oraInst.loc'
...
$installCommand = "java -jar /vagrant/$sx_pkg -silent -responseFile $responseFile -invPtrLoc $inventoryLocFile -jreLoc $JAVA_HOME -ignoreSysPrereqs"
